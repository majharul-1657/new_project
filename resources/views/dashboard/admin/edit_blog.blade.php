                        ...
                        <div class="row">
                            <div class="form-group col-12">
                                ...
                                <div>
                                    ...
                                    <img  class="admin-img" src="{{ asset($blog->image) }}" alt="" width="100px">
                                </div>
                            </div>

                            <div class="control-group col-12">
                         <div class="form-group row">
                            <label class="col-sm- col-form-label">Title <span class="text-danger">*</span></label>
                             <div class="col-sm">
                            ...
                            <div class="control-group col-12">
                                <div class="form-group row">
                                    <label class="col-sm- col-form-label">Slug <span class="text-danger">*</span></label>
                                     <div class="col-sm">
                            ...
                            <div class="control-group col-12">
                              <div class="form-group row">
                                <label class="col-sm- col-form-label">Description <span class="text-danger">*</span></label>
                               <div class="col-sm">
                                <textarea name="description" id="" cols="30" rows="10" class="summernote form-control">{!! ($blog->description) !!}</textarea>
                            ...
                            <div class="control-group col-12">
                              <div class="form-group row">
                                <label class="col-sm- col-form-label">Show Homepage <span class="text-danger">*</span></label>
                               <div class="col-sm">
                            ...
                            <div class="control-group col-12">
                               <div class="form-group row">
                                <label class="col-sm- col-form-label">SEO Title</label>
                                 <div class="col-sm">
                            ...
                            <div class="control-group col-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm- col-form-label">SEO Description</label>
                                       <div class="col-sm">
